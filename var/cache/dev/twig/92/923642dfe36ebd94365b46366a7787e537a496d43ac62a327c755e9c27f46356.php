...
class __TwigTemplate_cc29faf38c4549ead24195559ddfc4717da6e380212b538e93ed7e12d70d570c extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>S'inscrire</h1>
        ...
        ";
        // line 19
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 19, $this->source); })()), "login", [], "any", false, false, false, 19), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
        <br>
        ";
        // line 21
...
";
    ...
    {
        return array (  118 => 27,  111 => 23,  106 => 21,  101 => 19,  97 => 18,  89 => 12,  80 => 10,  76 => 9,  73 => 8,  66 => 7,  53 => 5,  36 => 1,);
    }
...
{% block body %}
    ...
    <h1>S'inscrire</h1>
        ...
        <div class=\"form-group\">{{ form_start(registrationForm) }}</div>
        {{ form_row(registrationForm.login,{'attr':{'class':'form-control'}} )}}
        <br>
...
{% endblock %}
", "registration/register.html.twig", "C:\\wamp64\\www\\TP_STOCK\\templates\\registration\\register.html.twig");
    }
}
