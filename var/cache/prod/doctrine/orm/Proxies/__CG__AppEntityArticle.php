...
class Article extends \App\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'reference', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'quantite'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNom(string $nom): \App\Entity\Article
    {
     ...
     * {@inheritDoc}
     */
    public function setPrix(int $prix): \App\Entity\Article
    {
     ...
     * {@inheritDoc}
     */
    public function setReference(string $reference): \App\Entity\Article
    {
